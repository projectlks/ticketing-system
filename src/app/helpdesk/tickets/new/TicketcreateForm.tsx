...
//     title: z.string().min(5, "Title must be at least 5 letters"),
//     description: z.string().min(10, "Description must be at least 10 letters"),
...
//                                     <div
//                                         key={s}
//                                         onClick={() => { if (mode === "edit") setForm((prev) => ({ ...prev, status: s })) }}
//                                         className={`
