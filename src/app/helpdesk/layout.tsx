...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  // မှတ်ချက် - ယခင်က ဤနေရာတွင်ရှိသော useEffect (Route ၈ ခုလုံးကို တစ်ပြိုင်နက် Data ဆွဲသောကုဒ်) ကို ဖယ်ရှားလိုက်ပါပြီ။
  // ထိုသို့ဖယ်ရှားလိုက်ခြင်းဖြင့် Network ပိတ်ဆို့မှုနှင့် API အကြိမ်ကြိမ်ခေါ်နေသည့် ပြဿနာကို ဖြေရှင်းနိုင်မည်ဖြစ်သည်။
