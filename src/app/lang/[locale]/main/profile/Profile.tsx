  ...
  return (
    <>
      <div className="flex-1 overflow-y-auto">
        <div className="rounded-2xl border border-gray-200 bg-white dark:bg-gray-900 dark:border-gray-700 p-5 lg:p-6">
  ...
  return (
    <section className="w-screen fixed top-0 left-0 flex justify-center min-h-screen overflow-auto h-screen items-center backdrop-blur-lg z-50">
      ...
      >
        ...
        <section className="p-5 space-y-6 max-h-[75vh] overflow-y-auto border-t border-gray-100 dark:border-gray-700 sm:p-6">
          {children}
        </section>
        <div className="mt-6 flex justify-end space-x-3 px-5 pb-5">
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-3 text-sm font-medium border border-gray-300 rounded-lg text-gray-800 dark:text-gray-200 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-800 h-[44px]"
          >
            Cancel
          </button>
          <button
