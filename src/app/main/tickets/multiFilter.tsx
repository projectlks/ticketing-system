...
export default function MultiFilter({ filters, setFilters }: Props) {
    ...
    return (
        <div className="relative" ref={wrapperRef}>
            ...
            {show && (
                <div className="absolute right-0 mt-2 z-10 w-[600px] bg-white border border-gray-300 rounded shadow-lg">
                    {/* Header */}
                    <div className="flex justify-between items-center border-b border-gray-300 px-5 py-2">
                        ...
                        <button
                            ...
                            className="text-xs whitespace-nowrap border border-gray-300 rounded px-2 py-1 hover:bg-gray-100"
                        >
                            Clear All
                        </button>
                    </div>
